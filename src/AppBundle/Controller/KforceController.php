...
class KforceController extends Controller
{
    ...
    /**
     * @Route("/ajax_kforce_household_header", 
     * 	name="ajax_kforce_household_header",
     *	options={"expose" = true}
     * )
     * @Method("POST")
     */
    ...
    /**
     * @Route("/ajax_patch_kforce_header/{householdId}", 
    ...
    public function ajaxPatchKforceHeaderAction(Request $request, $householdId)
    {
        $user = $this->get("security.token_storage")->getToken()->getUser();
        $em = $this->getDoctrine()->getManager("electPrep2024");
    ...
    /**
     * @Route("/ajax_get_datatable_kforce_header", name="ajax_get_datatable_household_header", options={"expose"=true})
     * @Method("GET")
     * @param Request $request
     * @return JsonResponse
     */

    public function ajaxGetDatatableKforceHeaderAction(Request $request)
    {
        $columns = array(
            0 => "h.household_code",
            1 => "h.voter_name",
    ...
    /**
     * @Route("/ajax_get_datatable_kforce_header_no_recruitment", name="ajax_get_datatable_household_header_no_recruitment", options={"expose"=true})
     * @Method("GET")
     * @param Request $request
     * @return JsonResponse
     */

    public function ajaxGetDatatableHouseholdKforceNoRecruitmentAction(Request $request)
    {
        $columns = array(
            0 => "h.household_code",
            1 => "h.voter_name",
    ...
    /**
     * @Route("/ajax_delete_kforce_header/{householdId}", 
    ...
    public function ajaxDeleteKforceHeaderAction($householdId)
    {
        $em = $this->getDoctrine()->getManager("electPrep2024");
        ;
    ...
    /**
     * @Route("/ajax_get_kforce_header/{id}",
    ...
    public function ajaxGetKforceHeader($id)
    {
        $em = $this->getDoctrine()->getManager("electPrep2024");
        ;
        $entity = $em->getRepository("AppBundle:HouseholdHeader")
    ...
    /**
     * @Route("/ajax_get_household_kforce_full/{id}",
     *       name="ajax_get_household_kforce_full",
     *        options={ "expose" = true }
     * )
     * @Method("GET")
     */

    public function ajaxGetKforceFullHeader($id)
    {
        $em = $this->getDoctrine()->getManager("electPrep2024");
        ;
    ...
    /**
     * @Route("/ajax_post_kforce_detail", 
     * 	name="ajax_post_kforce_detail",
     *	options={"expose" = true}
     * )
     * @Method("POST")
     */

    public function ajaxPostKforceDetailAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager("electPrep2024");
        ;
        $user = $this->get("security.token_storage")->getToken()->getUser();
    ...
    /**
     * @Route("/ajax_kforce_select2_relationship",
     *       name="ajax_kforce_select2_relationship",
     *       options={ "expose" = true }
     * )
     * @Method("GET")
     */

    public function ajaxKforceSelect2Relationship(Request $request)
    {
        $em = $this->getDoctrine()->getManager("electPrep2024");
    ...
    /**
     * @Route("/ajax_get_datatable_kforce_household_detail", name="ajax_get_datatable_kforce_household_detail", options={"expose"=true})
     * @Method("GET")
     * @param Request $request
     * @return JsonResponse
     */

    public function ajaxGetDatatableKforceHouseholdDetailAction(Request $request)
    {
        $columns = array(
            0 => "h.household_id",
            1 => "h.voter_name",
    ...
    /**
     * @Route("/ajax_delete_kforce_household_detail/{householdDetailId}", 
     * 	name="ajax_delete_kforce_household_detail",
     *	options={"expose" = true}
     * )
     * @Method("DELETE")
     */

    public function ajaxDeleteKforceHouseholdDetailAction($householdDetailId)
    {
        $em = $this->getDoctrine()->getManager("electPrep2024");
        ;
    ...
    /**
     * @Route("/ajax_fill_kforce_household_summary", 
     * 	name="ajax_fill_kforce_household_summary",
     *	options={"expose" = true}
     * )
     * @Method("GET")
     */

    public function ajaxFillKforceHouseholdSummaryAction(Request $request)
    {
        $user = $this->get("security.token_storage")->getToken()->getUser();
    ...
    /**
     * @Route("/ajax_kforce_household_get_transfer_profiles",
     *       name="ajax_kforce_household_get_transfer_profiles",
     *        options={ "expose" = true }
     * )
     * @Method("GET")
     */

    public function ajaxKforceTransferProfiles(Request $request)
    {
        $em = $this->getDoctrine()->getManager("electPrep2024");
    ...
    /**
     * @Route("/ajax_kforce_household_generate_household_no",
     *       name="ajax_kforce_household_generate_household_no",
     *        options={ "expose" = true }
     * )
     * @Method("GET")
     */

    public function ajaxKforceGenerateHouseholdNo(Request $request)
    {
        $em = $this->getDoctrine()->getManager("electPrep2024");
    ...
    /**
     * @Route("/ajax_patch_kforce_household_notes/{householdId}", 
     * 	name="ajax_patch_kforce_household_notes",
     *	options={"expose" = true}
     * )
     * @Method("PATCH")
     */

    public function ajaxPatchKforceHouseholdNotesAction(Request $request, $householdId)
    {
        $user = $this->get("security.token_storage")->getToken()->getUser();
        $em = $this->getDoctrine()->getManager("electPrep2024");
    ...
    /**
     * @Route("/ajax_get_table_kforce_household_headers", name="ajax_get_table_household_headers", options={"expose"=true})
     * @Method("GET")
     * @param Request $request
     * @return JsonResponse
     */

    public function ajaxGetTableKforceHouseholdHeadersAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager("electPrep2024");
    ...
    /**
     * @Route("/ajax_get_table_kforce_household_monitoring_by_barangay", name="ajax_get_table_kforce_household_monitoring_by_barangay", options={"expose"=true})
     * @Method("GET")
     * @param Request $request
     * @return JsonResponse
     */

    public function ajaxGetTableKforceHouseholdMonitoringByBarangayAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager("electPrep2024");
    ...
    /**
     * @Route("/ajax_get_table_kforce_household_monitoring_by_date", name="ajax_get_table_kforce_household_monitoring_by_date", options={"expose"=true})
     * @Method("GET")
     * @param Request $request
     * @return JsonResponse
     */

    public function ajaxGetTableKforceHouseholdMonitoringByDateAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager("electPrep2024");
     ...
     /**
     * @Route("/ajax_m_get_kforce_household_voters_summary",
     *       name="ajax_m_get_kforce_household_voters_summary",
     *        options={ "expose" = true }
     * )
     * @Method("GET")
     */

     public function ajaxGetKforceHouseholdVotersSummary(Request $request)
     {
    ...
    /**
     * @Route("/ajax_m_get_kforce_household_voters_summary_by_barangay/{municipalityNo}",
     *       name="ajax_m_get_kforce_household_voters_summary_by_barangay",
     *        options={ "expose" = true }
     * )
     * @Method("GET")
     */

     public function ajaxGetKforceHouseholdVotersSummaryByBarangay(Request $request, $municipalityNo )
     {
         $em = $this->getDoctrine()->getManager("electPrep2024");
