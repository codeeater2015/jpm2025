...
/**
 * @Route("/photo-upload-v2")
 */

class PhotoUploadV2Controller extends Controller
{
    /**
     * @Route("", name="photo_upload_v2_index", options={"main" = true})
     */
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('template/photo-upload-v2/index.html.twig', ['user' => $user, 'hostIp' => $hostIp, 'imgUrl' => $imgUrl]);
    }

    /**
     * @Route("/mobile", name="photo_upload_v2_mobile", options={"main" = true})
     */
     ...
     public function mobileAction(Request $request)
     {
         ...
         return $this->render('template/photo-upload-v2/mobile.html.twig', ['user' => $user, 'hostIp' => $hostIp, 'imgUrl' => $imgUrl]);
     }

    /**
     * @Route("/ajax_get_photo_upload_v2_remaining_photos_per_municipality",
     *       name="ajax_get_photo_upload_v2_remaining_photos_per_municipality",
     *        options={ "expose" = true }
     * )
     * @Method("GET")
     */

     public function ajaxGetGetPhotoUploadV2RemainingPhotosPerMunicipality(Request $request)
     {
    ...
    /**
     * @Route("/ajax_field_photo_upload_v2",
     *     name="ajax_field_photo_upload_v2",
     *     options={"expose" = true}
     *     )
     * @Method("POST")
     */
    ...
    public function compress($source, $destination, $quality)
    {
     ...
     /**
     * @Route("/ajax_get_photo_uploads_v2_for_tagging",
     *       name="ajax_get_photo_uploads_v2_for_tagging",
     *        options={ "expose" = true }
     * )
     * @Method("GET")
     */
    ...
    /**
     * @Route("/ajax_datatable_field_upload_v2", name="ajax_datatable_field_upload_v2", options={"expose"=true})
     * @Method("GET")
    ...
    /**
     * @Route("/ajax_datatable_field_upload_items_v2", name="ajax_datatable_field_upload_items_v2", options={"expose"=true})
     * @Method("GET")
     * @param Request $request
     * @return JsonResponse
     */
    ...
    /**
     * @Route("/ajax_get_field_upload_images_v2/{hdrId}",
     *       name="ajax_get_field_upload_images_v2",
     *        options={ "expose" = true }
     * )
     * @Method("GET")
     */
    ...
    /**
     * @Route("/photo/{id}",
     *   name="ajax_get_field_upload_photo_v2",
     *   options={"expose" = true}
     * )
     * @Method("GET")
     */
     ...
     *   name="ajax_patch_photo_upload_item_v2",
     *   options={"expose" = true}
     * )
     * @Method("PATCH")
     */
    ...
    private function generateProIdCode($proId, $voterName, $municipalityNo)
    {
      ...
      /**
     * @Route("/item_detail/{id}",
     *   name="ajax_get_field_upload_item_detail_v2",
     *   options={"expose" = true}
     * )
     * @Method("GET")
     */
    ...
    /**
     * @Route("/album/{id}",
     *   name="ajax_delete_field_upload_v2",
     *   options={"expose" = true}
     * )
     * @Method("DELETE")
     */
    ...
    public function ajaxDeleteFieldUploadAction($id)
    {
        ...
        foreach ($images as $img) {
            $imagePath = $rootDir . '/' . $img->getCreatedBy() . '/' . $entity->getBrgyNo() .  '/' .  $entity->getVoterGroup() . '/' . $img->getFilename();
            if (file_exists($imagePath)) {
                unlink($imagePath);
            }
    ...
    /**
     * @Route("/album/item/{id}",
     *   name="ajax_delete_field_upload_item_v2",
     *   options={"expose" = true}
     * )
     * @Method("DELETE")
     */
     ...
     *   name="ajax_get_download_photo_album_v2",
     *   options={"expose" = true}
     * )
     * @Method("GET")
     */
    ...
    /**
    * @Route("/ajax_get_field_upload_no_id_v2", 
    *   name="ajax_get_field_upload_no_id_v2",
    *   options={"expose" = true}
    * )
    * @Method("GET")
    */
    ...
    /**
    * @Route("/ajax_get_rename_no_file_extension_v2", 
    *   name="ajax_get_rename_no_file_extension_v2",
    *   options={"expose" = true}
    * )
    * @Method("GET")
    */
    ...
    /**
    * @Route("/ajax_get_rename_with_spaces_v2", 
    *   name="ajax_get_rename_with_spaces_v2",
    *   options={"expose" = true}
    * )
    * @Method("GET")
    */
    ...
    public function ajaxRenameWithSpaces(Request $request){
     ...
     /**
     * @Route("/ajax_select2_upload_reason_v2",
     *       name="ajax_select2_upload_reason_v2",
     *       options={ "expose" = true }
     * )
     * @Method("GET")
     */
    ...
    /**
     * @Route("/ajax_upload_generate_summary_v2",
     *       name="ajax_upload_generate_summary_v2",
     *       options={ "expose" = true }
     * )
     * @Method("GET")
     */
    ...
    /**
     * @Route("/ajax_upload_generate_summary_by_municipality_v2/{municipalityCode}",
     *       name="ajax_upload_generate_summary_by_municipality_v2",
     *       options={ "expose" = true }
     * )
     * @Method("GET")
     */
    ...
    private function generateSummary($municipalityCode,$voterGroup){
     ...
     /**
     * @Route("/item_detail-no-photo-jpm/{id}",
     *   name="ajax_patch_photo_upload_item_no_photo_jpm",
     *   options={"expose" = true}
     * )
     * @Method("PATCH")
     */

     public function ajaxPatchFieldUploadNoPhotoAction($id, Request $request)
     {
