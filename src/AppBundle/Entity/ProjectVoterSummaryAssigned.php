...
/**
 * ProjectVoterSummaryAssigned
 *
 * @ORM\Table(name="tbl_project_voter_summary_assigned")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ProjectVoterSummaryAssignedRepository")
...
class ProjectVoterSummaryAssigned
{
      /**
     * @var int
     *
