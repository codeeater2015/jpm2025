...
/**
 * RecruitementSpecialHeader
 *
 * @ORM\Table(name="tbl_recruitment_special_hdr")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\SpecialOperationHeaderRepository")
 */

class SpecialOperationHeader
{
    /**
     * @var int
     *
