var FormStatusChecklistDatatable = React.createClass({displayName: "FormStatusChecklistDatatable",
    ...
    render: function () {
        return (
            React.createElement("div", null, 
                React.createElement("div", {className: "row", id: "checklist_component"}, 
                    ...
                    React.createElement("div", {className: "col-md-1"}, 
                        React.createElement("button", {className: "btn red-sunglo btn-sm", onClick: this.export}, " ", React.createElement("i", {className: "fa fa-file-excel-o"}), " Export List ")
                    ), 

                    React.createElement("div", {className: "col-md-2 col-md-offset-1"}, 
                        React.createElement("select", {id: "summary_date_select2", className: "form-control form-filter input-sm"}
                        )
                    ), 

                    React.createElement("div", {className: "col-md-1"}, 
                        React.createElement("button", {className: "btn red-sunglo btn-sm", onClick: this.exportSummary}, " ", React.createElement("i", {className: "fa fa-file-excel-o"}), " Export Province Summary ")
                    )
                ...
                React.createElement("div", {className: "table-container"}, 
                    ...
                    React.createElement("table", {id: "checklist_table", className: "table table-striped table-bordered", width: "100%"}, 
                        React.createElement("thead", null, 
                            React.createElement("tr", null, 
                                ...
                                React.createElement("th", {className: "text-center"}, "HH"), 
                                React.createElement("th", {className: "text-center"}, "REC"), 
                            ...
                            React.createElement("tr", null, 
                                ...
                                React.createElement("td", {style: { padding: "10px 5px"}}, 
                                    React.createElement("select", {className: "form-control form-filter input-sm", name: "house_form_sub", onChange: this.handleFilterChange}, 
                                ...
                                React.createElement("td", {style: { padding: "10px 5px"}}, 
                                    React.createElement("select", {className: "form-control form-filter input-sm", name: "rec_form_sub", onChange: this.handleFilterChange}, 
                                        React.createElement("option", {value: ""}, "- - -"), 
                                        React.createElement("option", {value: "1"}, "YES"), 
                                        React.createElement("option", {value: "0"}, "NO")
                                    )
                                ...
                                React.createElement("td", {style: { padding: "10px 5px"}}, 
                                    React.createElement("select", {className: "form-control form-filter input-sm", name: "is_non_voter", onChange: this.handleFilterChange}, 
                                        React.createElement("option", {value: ""}, "- - -"), 
                                        React.createElement("option", {value: "1"}, "YES"), 
                                        React.createElement("option", {value: "0"}, "NO")
                                    )
...
var FormStatusChecklist = React.createClass({displayName: "FormStatusChecklist",
        ...
        return (
            React.createElement("div", {className: "portlet light portlet-fit bordered"}, 
                React.createElement("div", {className: "portlet-body"}, 
                    React.createElement(FormStatusChecklistDatatable, {notify: this.notify})
                )
            )
        )
    }
...
setTimeout(function(){
    ReactDOM.render(
    React.createElement(FormStatusChecklist, null),
