                ...
                processResults: function (data, params) {
                    return {
                        results: data.map(function (item) {
                            ...
                            var id = parseInt(item.has_id) == 1 ? 'Y : ' + item.date_generated   : "N";
                            console.log(item);
                            ...
                            React.createElement("div", {className: "col-md-7"}, 
                                ...
                                React.createElement("div", {className: "row"}, 
                                    React.createElement("div", {className: "col-md-4"}, 
                                        ...
                                        React.createElement("label", {className: "mt-checkbox"}, 
                                            React.createElement("input", {type: "checkbox", name: "isDuplicate", checked: data.isDuplicate == 1, onChange: this.setFormCheckProp}), 
                                            "Is Duplicate", 
                                            React.createElement("span", null)
                                        )
                                    ), 
                    ...
                    React.createElement("div", {className: "row"}, 
                        ...
                        React.createElement("div", {className: "col-md-12"}, 
                            React.createElement("div", {className: "mt-radio-inline"}, 
                                ...
                                React.createElement("label", {className: "mt-radio"}, 
                                    React.createElement("input", {type: "radio", name: "uploadFilter", onChange: this.setUploadFilter, value: "DUPLICATE", checked: this.state.uploadFilter == "DUPLICATE"}), "DUPLICATE", 
                                    React.createElement("span", null)
                                ), 
...
var SpecialOperationDatatable = React.createClass({displayName: "SpecialOperationDatatable",
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row) {
                            ...
                            var listBtn = "<a href='javascript:void(0);' class='btn btn-xs font-white bg-green list-button' data-toggle='tooltip' data-title='List'>List</i></a>";
                            var deleteBtn = "<a href='javascript:void(0);' class='btn btn-xs font-white bg-red-sunglo delete-button' data-toggle='tooltip' data-title='Delete'><i class='fa fa-trash' ></i></a>";
                            return  uploadBtn + photoBtn + printBtn + deleteBtn;
                        }
                    }
                ],
            }
    ...
    showList : function (id) {
        var url = "http://" + window.hostIp + ":83/jpm/so-list/index.php?rec_id=" + id;
        this.popupCenter(url, 'SO LIST', 900, 600);
    },
                ...
                React.createElement("div", {className: "table-container", style: { marginTop: "20px"}}, 
                    React.createElement("table", {id: "recruitment_table", className: "table table-striped table-bordered", width: "100%"}, 
                        React.createElement("thead", null, 
                            React.createElement("tr", null, 
                                React.createElement("th", null, "No"), 
                                React.createElement("th", null, "Leader"), 
                                ...
                                React.createElement("th", {className: "text-center"}, "Photos"), 
                                React.createElement("th", {className: "text-center"}, "Linked"), 
                                React.createElement("th", {className: "text-center"}, "Unlinked"), 
                                React.createElement("th", {className: "text-center"}, "Not Found"), 
                                React.createElement("th", {className: "text-center"}, "Duplicate"), 
                                React.createElement("th", {className: "text-center"}, "For Print"), 
