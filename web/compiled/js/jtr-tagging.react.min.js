var JtrTaggingDatatable = React.createClass({displayName: "JtrTaggingDatatable",
    ...
    render: function () {
        return (
            React.createElement("div", null, 
                    ...
                    React.createElement(PulahanCreateModal, {
                ...
                React.createElement("div", {className: "row", id: "handler_component"}, 
                    React.createElement("div", {className: "col-md-5"}, 
                        React.createElement("button", {type: "button", className: "btn btn-primary", onClick: this.openCreateModal}, "Add Voter")
                    ), 
                ...
                React.createElement("div", {className: "table-container", style: { marginTop: "20px" ,backgroundColor:"#c4c4c4" , padding:"20px"}}, 
                    React.createElement("table", {id: "jtr_tagging_datatable", className: "table table-condensed table-bordered", width: "100%"}, 
                        React.createElement("thead", null, 
                            React.createElement("tr", null, 
                                React.createElement("th", null, "No"), 
                                React.createElement("th", null, "Voter Name"), 
                                React.createElement("th", {className: "text-center"}, "JTR Leader "), 
                                React.createElement("th", {className: "text-center"}, "JTR Member"), 
                                React.createElement("th", {className: "text-center"}, "Precinct #"), 
                                ...
                                React.createElement("th", {className: "text-center"}, "Position")
                            ), 
                            React.createElement("tr", null, 
                                ...
                                React.createElement("td", null, 
                                    React.createElement("select", {name: "is1CheckFilter", onChange: this.handleFilterChange, className: "input-sm", style: { marginTop: "2px"}}, 
                                ...
                                React.createElement("td", null, 
                                    React.createElement("select", {name: "is2CheckFilter", onChange: this.handleFilterChange, className: "input-sm", style: { marginTop: "2px"}}, 
                                        React.createElement("option", {value: ""}, "All"), 
                                        React.createElement("option", {value: "1"}, "Yes"), 
                                        React.createElement("option", {value: "0"}, "No")
                                    )
                                ...
                                React.createElement("td", {style: { padding: "10px 5px"}}, 
                                    React.createElement("input", {type: "text", className: "form-control form-filter input-sm", name: "precinct_no", onChange: this.handleFilterChange})
                                ), 
                                React.createElement("td", null), 
                                React.createElement("td", null), 
                                React.createElement("td", {style: { padding: "10px 5px"}}, 
                    ...
                    React.createElement("div", {className: "col-md-12"}, 
                        React.createElement("div", {className: "portlet light portlet-fit bordered"}, 
                            React.createElement("div", {className: "portlet-body"}, 
                                React.createElement("h4", null, React.createElement("strong", null, "JTR Tagging")), 
                                React.createElement(JtrTaggingDatatable, null)
                            )
                        )
                    )
                )
