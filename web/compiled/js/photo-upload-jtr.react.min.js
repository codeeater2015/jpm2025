...
var PhotoUploadItemEditModal = React.createClass({displayName: "PhotoUploadItemEditModal",
                        ...
                        React.createElement("div", {className: "row"}, 
                            React.createElement("div", {className: "col-md-5"}, 
                                React.createElement("a", {className: "thumbnail"}, 
                                    React.createElement("img", {className: "zoom", "data-magnify-src": imgUrl, src: imgUrl})
                                )
                            ), 
                            ...
                            React.createElement("div", {className: "col-md-7"}, 
                                ...
                                React.createElement("div", {className: "row"}, 
                                    ...
                                    React.createElement("div", {className: "col-md-3"}, 
                                        React.createElement("button", {style: { marginTop: "27px"}, onClick: this.openNewVoterCreateModal, className: "btn btn-primary btn-sm", type: "button"}, " Non-voter ")
                                    )
                                ), 
                        ...
                        React.createElement("div", {className: "row"}, 
                            React.createElement("div", {className: "col-md-12"}, 
                                React.createElement("div", {className: "text-right"}, 
                                     ((data.proVoterId != null && data.proVoterId != "") || data.isNotFound == 1) && (Number.parseInt(data.hasNewPhoto) == 0 || data.hasNewPhoto == "" ) && React.createElement("button", {type: "button", className: "btn blue-madison", style: { marginRight: "5px"}, onClick: this.submit}, "Submit & Crop"), 
                                     (data.isNotFound == 1) && React.createElement("button", {type: "button", className: "btn blue-madison", style: { marginRight: "5px"}, onClick: this.submit}, "Submit & Crop"), 
                                     ((data.proVoterId != null && data.proVoterId != "") || data.isNotFound == 1) && (Number.parseInt(data.hasNewPhoto) == 1  ) && React.createElement("button", {type: "button", className: "btn blue-madison", style: { marginRight: "5px"}, onClick: this.tagJtr}, "Reprint ID"), 
...
var PhotoUploadItemsModal = React.createClass({displayName: "PhotoUploadItemsModal",
    getInitialState: function () {
        return {
            proIdCode: null,
            member: null,
            ...
            React.createElement(Modal, {style: { marginTop: "10px"}, keyboard: false, dialogClassName: "modal-full", enforceFocus: false, backdrop: "static", show: this.props.show, onHide: this.props.onHide}, 
                ...
                React.createElement(Modal.Body, {bsClass: "modal-body overflow-auto"}, 
                    React.createElement("div", {className: "row"}, 
                            ...
                            (
                                React.createElement(PhotoUploadItemEditModal, {
...
var PhotoUploadModal = React.createClass({displayName: "PhotoUploadModal",
...
var FieldUploadDatatable = React.createClass({displayName: "FieldUploadDatatable",
    ...
    render: function () {
        return (
            React.createElement("div", null, 
                    ...
                    React.createElement(PhotoUploadItemsModal, {
                    ...
                    React.createElement("table", {id: "field_photo_table", className: "table table-striped table-bordered", width: "100%"}, 
                        React.createElement("thead", null, 
                            React.createElement("tr", null, 
                                ...
                                React.createElement("th", {className: "text-center"}, "Linked"), 
                                React.createElement("th", {className: "text-center"}, "UnLinked"), 
                                React.createElement("th", {className: "text-center"}, React.createElement("small", null, "W/PHOTO")), 
                                React.createElement("th", {className: "text-center"}, React.createElement("small", null, "W/ID")), 
                            ...
                            React.createElement("tr", null, 
                                ...
                                React.createElement("td", {className: "text-center"}, this.state.gUnlinked), 
                                React.createElement("td", {className: "text-center"}, this.state.gPhotos), 
                                React.createElement("td", {className: "text-center"}, this.state.gId), 
                                React.createElement("td", {className: "text-center"}
                                )
                            ), 
                            React.createElement("tr", null, 
...
var PhotoUpload = React.createClass({displayName: "PhotoUpload",
            ...
            React.createElement("div", null, 
                React.createElement("div", {className: "row"}, 
                    React.createElement("div", {className: "col-md-8"}, 
                        React.createElement("div", {className: "portlet light portlet-fit bordered"}, 
                            React.createElement("div", {className: "portlet-body"}, 
                                React.createElement("div", {className: "row"}, 
                                    React.createElement("div", {className: "col-md-8"}, 
                                        React.createElement("h4", null, React.createElement("strong", null, "JPM-JTR Photo Uploads"))
                                    )
                                ), 
                                this.state.showDatatable &&
                                    React.createElement(FieldUploadDatatable, {ref: "fieldDatatable", municipalityName: this.state.municipalityName})
                    ...
                    React.createElement("div", {className: "col-md-4"}, 
                        React.createElement("div", {className: "portlet light portlet-fit bordered"}, 
                            React.createElement("div", {className: "portlet-body"}, 
                                React.createElement("h4", null, React.createElement("strong", null, "Upload JTR Images Here")), 
...
setTimeout(function () {
    ReactDOM.render(
        React.createElement(PhotoUpload, null),
