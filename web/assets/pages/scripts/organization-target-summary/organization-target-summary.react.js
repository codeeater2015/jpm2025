var OrganizationTargetSummaryComponent = React.createClass({
                        ...
                        <div className="col-md-9" style={{ padding: "0px" }}>
                            {
                                ...
                                <OrganizationProvinceTargetSummaryTable 
...

                            {
                                ...
                                <OrganizationMunicipalityTargetSummaryTable 
                                    electId={this.state.electId} 
                                    proId={this.state.proId} 
                                    provinceCode={this.state.provinceCode} 
...

                            {
                                ...
                                <OrganizationBarangayTargetSummaryTable 
                                    electId={this.state.electId} 
                                    proId={this.state.proId} 
                                    provinceCode={this.state.provinceCode} 
                                    municipalityNo={this.state.municipalityNo} 
...
setTimeout(function () {
    ReactDOM.render(
        <OrganizationTargetSummaryComponent />,
