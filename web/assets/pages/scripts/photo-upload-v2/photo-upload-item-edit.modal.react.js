...
var PhotoUploadItemEditModal = React.createClass({
    ...
    tagJpm: function (e) {
        ...
        self.requestPost = $.ajax({
            url: Routing.generate('ajax_patch_photo_upload_item_no_photo_jpm', {
                id: this.props.itemId
            }),
            type: "PATCH",
            data: (data)
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <div className="text-right" >
                                    {(data.proVoterId != null && data.proVoterId != "")  && (Number.parseInt(data.hasNewPhoto) == 1  ) && <button type="button" className="btn blue-madison" style={{ marginRight: "5px" }} onClick={this.tagJpm}>Tag Only</button>}
                                    ...
                                    { (data.isNotFound == 1) && <button type="button" className="btn blue-madison" style={{ marginRight: "5px" }} onClick={this.submit}>Submit Not Found</button>}
