...
var SmsModal = React.createClass({
        ...
        return (
            <Modal keyboard={false} enforceFocus={false} dialogClassName="modal-full" show={this.props.show} onHide={this.props.onHide}>
                <Modal.Header className="modal-header bg-blue-dark font-white bold" closeButton>
                    <Modal.Title>SMS Form</Modal.Title>
                </Modal.Header>
                    ...
                    <form id="sms-form" onSubmit={this.submit}>
                        <div className="col-md-3">
                            ...
                            <div>
                                <div className="col-md-12" style={{ padding: 0 }}>
                                    <label className="control-label">Extra Filters</label>
                                </div>
                                <div className="col-md-6" style={{ padding: 0 }}>
                                    <div className="mt-checkbox-list">
                                        <label className="mt-checkbox">
                                            <input type="checkbox" name="withBirthdate" checked={data.withBirthdate} onChange={this.setFormCheckProp} />
                                            Today's BDay
                                        <span></span>
                                        </label>
                                        <label className="mt-checkbox">
                                            <input type="checkbox" name="withNoBirthdate" checked={data.withNoBirthdate} onChange={this.setFormCheckProp} />
                                            No Birthdate
                                        <span></span>
                                        </label>
                                        <label className="mt-checkbox">
                                            <input type="checkbox" name="isNonVoter" checked={data.isNonVoter} onChange={this.setFormCheckProp} />
                                                Is Non-voter
                                            <span></span>
                                        </label>
                                    </div>
                                ...
                                <div className="col-md-6" style={{ padding: 0 }}>
                                    <div className="mt-checkbox-list">
                                        ...
                                        <label className="mt-checkbox">
                                        <input type="checkbox" name="isVoter" checked={data.isVoter} onChange={this.setFormCheckProp} />
                                            Is Voter
                                            <span></span>
                                        </label>
                                    </div>
                        ...
                        <div className="col-md-9">
                            ...
                            <FormGroup controlId="formProfiles" validationState={this.getValidationState('students')} >
                                <select multiple ref="selectBox" className="searchable" id="voters" name="voters[]">
                                    {this.state.votersList.map(function (item) {
                                        ...
                                        return (<option key={item.pro_voter_id} disabled={withoutNumber} value={item.pro_voter_id}>{item.voter_name} - {item.voter_group} ({cpLabel} , {bdayLabel}) </option>)
                                    })}
                                </select>
                                <div className="text-right">
                            ...
                            <FormGroup controlId="formMessageBody" validationState={this.getValidationState('messageBody')}>
                                ...
                                <div className="text-right">
                                    <label>Letter Count : {data.messageBody.length} </label>
                                </div>
