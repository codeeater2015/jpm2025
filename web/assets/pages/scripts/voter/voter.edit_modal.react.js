                        ...
                        <div className="col-md-4">
                            ...
                            <div className="profile-userbuttons" style={{ marginTop: "10px" }}>
                                <span className="btn col-md-12 green btn-sm fileinput-button ">
                                    ...
                                    <input id="voter-photo-upload" type="file" name="files[]" data-url={Routing.generate('ajax_upload_project_voter_photo', { proId: this.props.proId, proVoterId: this.props.proVoterId })} multiple={false} />
                                </span>
                            </div>
