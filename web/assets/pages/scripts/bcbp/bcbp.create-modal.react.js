...
var BcbpCreateModal = React.createClass({
        ...
        return (
            <Modal style={{ marginTop: "10px" }} bsSize="lg" keyboard={false} enforceFocus={false} backdrop="static" show={this.props.show} onHide={this.props.onHide}>
                <Modal.Header className="modal-header bg-blue-dark font-white" closeButton>
                    <Modal.Title>New BCBP Profile</Modal.Title>
                </Modal.Header>
                                ...
                                <div className="row">
                                    <div className="col-md-3" >
                                        <FormGroup controlId="formFirstname" validationState={this.getValidationState('firstname')}>
                                            ...
                                            <input type="text"   name="firstname" value={ this.state.form.data.firstname} className="input-md form-control" onChange={this.setFormProp} />
                                        </FormGroup>
                                    </div>
                                    <div className="col-md-3" >
                                        <FormGroup controlId="formLastname" validationState={this.getValidationState('lastname')}>
                                            <ControlLabel > Lastname : </ControlLabel>
                                            <input type="text" name="lastname" value={ this.state.form.data.lastname}  className="input-md form-control" onChange={this.setFormProp} />
                                        </FormGroup>
                                    </div>
                                    <div className="col-md-3" >
                                        <FormGroup controlId="formBirthdate" validationState={this.getValidationState('birthdate')}>
                                            <ControlLabel > Birthday : </ControlLabel>
                                            <input type="date" className="input-md form-control" value={ this.state.form.data.birthdate}  name="birthdate" onChange={this.setFormProp} />
                                        </FormGroup>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-3" >
                                        <FormGroup controlId="formNickname" validationState={this.getValidationState('nickname')}>
                                            ...
                                            <input type="text"  name="nickname" value={ this.state.form.data.nickname}  className="input-md form-control" onChange={this.setFormProp} />
                                        </FormGroup>
                                    </div>
                                </div>
                                <div className="row">
