...
var ProjectRecruitmentSpecialCreateModal = React.createClass({
        ...
        return (
            <Modal style={{ marginTop : "10px" }} keyboard={false} enforceFocus={false} backdrop="static" show={this.props.show} onHide={this.props.onHide}>
                <Modal.Header className="modal-header bg-blue-dark font-white" closeButton>
                    <Modal.Title>KCL Form</Modal.Title>
                </Modal.Header>
    ...
    loadVoter: function (proId, voterId) {
        ...
        self.requestVoter = $.ajax({
            ...
            form.data.voterGroup = self.isEmpty(res.voterGroup) ? "KCL" : res.voterGroup;
    ...
    submit : function(e){
        ...
        self.requestPost = $.ajax({
            url: Routing.generate("ajax_post_project_recruitment_special_kcl"),
            data: data,
            type: 'POST'
        }).done(function(res){
            self.reset();
...
window.ProjectRecruitmentSpecialCreateModal = ProjectRecruitmentSpecialCreateModal;