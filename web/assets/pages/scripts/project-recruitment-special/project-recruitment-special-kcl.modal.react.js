...
var ProjectRecruitmentSpecialKclModal = React.createClass({
        ...
        return (
            <Modal style={{ marginTop: "10px" }} keyboard={false} dialogClassName="modal-custom-95" enforceFocus={false} backdrop="static" show={this.props.show} onHide={this.props.onHide}>
                <Modal.Header className="modal-header bg-blue-dark font-white" closeButton>
                    <Modal.Title>KCL Recruitment Modal</Modal.Title>
                </Modal.Header>
                <Modal.Body bsClass="modal-body overflow-auto">

                    {
                        this.state.showAddMemberModal &&
                        <ProjectRecruitmentSpecialHouseholdModal
                    ...
                    <div className="col-md-7" style={{ paddingLeft: "0px", marginBottom: "10px" }}>
                        <button onClick={this.openAddMemberModal} type="button" className="btn btn-sm btn-primary">New Household Leader</button>
                    </div>

                    <ProjectRecruitmentHouseholdDatatable ref="DetailDatatable" proId={this.props.proId} notify={this.props.notify} recId={this.props.recId}></ProjectRecruitmentHouseholdDatatable>
                </Modal.Body>
            </Modal>
        );
    },
...
window.ProjectRecruitmentSpecialKclModal = ProjectRecruitmentSpecialKclModal;