...
var ProjectRecruitmentSpecialHouseholdModal = React.createClass({
    ...
    loadVoter: function (proId, voterId) {
        ...
        self.requestVoter = $.ajax({
            ...
            form.data.voterGroup = self.isEmpty(res.voterGroup) ? 'KCL0' : res.voterGroup;
    ...
    submit: function (e) {
        ...
        self.requestAddAttendee = $.ajax({
            url: Routing.generate("ajax_post_project_recruitment_special_household_leader"),
            type: "POST",
            data: data
        }).done(function (res) {
            self.reset();
        ...
        return (
            <Modal keyboard={false} enforceFocus={false} dialogClassName="modal-custom-40" backdrop="static" show={this.props.show} onHide={this.props.onHide}>
                <Modal.Header className="modal-header bg-blue-dark font-white" closeButton>
                    <Modal.Title>Household Leader Form</Modal.Title>
                </Modal.Header>
...
window.ProjectRecruitmentSpecialHouseholdModal = ProjectRecruitmentSpecialHouseholdModal;