...
var FinancialAssistanceCreateNewProfileModal = React.createClass({
    ...
    render: function () {
        ...
        return (
            <Modal style={{ marginTop: "150px" }} keyboard={false} dialogClassName="modal-custom-85" enforceFocus={false} backdrop="static" show={this.props.show} onHide={this.props.onHide}>
...
window.FinancialAssistanceCreateNewProfileModal = FinancialAssistanceCreateNewProfileModal;