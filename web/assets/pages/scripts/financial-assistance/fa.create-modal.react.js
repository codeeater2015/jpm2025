...
var FinancialAssistanceCreateModal = React.createClass({
        ...
        return (
            <Modal style={{ marginTop: "10px" }} bsSize="lg" keyboard={false} enforceFocus={false} backdrop="static" show={this.props.show} onHide={this.props.onHide}>
                <Modal.Header className="modal-header bg-blue-dark font-white" closeButton>
                    <Modal.Title>Financial Assistance Form</Modal.Title>
                </Modal.Header>
                <Modal.Body bsClass="modal-body overflow-auto">

                    {
                        this.state.showNewProfileModal &&
                        <FinancialAssistanceCreateNewProfileModal  
                            proId={3}
                            electId={4}
                            provinceCode={53}
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <FormGroup controlId="formRemarks" validationState={this.getValidationState('remarks')}>
                                            <ControlLabel> Remarks / Brief Explanation : </ControlLabel>
    ...
    initSelect2: function () {
        ...
        $("#fa-form #beneficiary-select2").on("change", function () {
            self.loadBeneficiary(3, $(this).val());
        });
    ...
    loadBeneficiary: function (proId, proVoterId) {
        var self = this;
        self.requestVoter = $.ajax({
            url: Routing.generate("ajax_get_project_voter", { proId: proId, proVoterId: proVoterId }),
            type: "GET"
            ...
            var form = self.state.form;
            form.data.beneficiaryName = res.voterName;
            form.data.beneficiaryProVoterId = res.proVoterId;
        ...
        form.data.beneficiaryName = "";
        form.data.beneficiaryProVoterId = "";
    ...
    submit: function (e) {
        ...
        self.requestPost = $.ajax({
            url: Routing.generate("ajax_post_fa_header"),
            data: data,
            type: 'POST'
        }).done(function (res) {
            self.reset();
...
window.FinancialAssistanceCreateModal = FinancialAssistanceCreateModal;