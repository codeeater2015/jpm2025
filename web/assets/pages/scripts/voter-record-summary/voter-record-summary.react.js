var VoterSummaryComponent = React.createClass({
                        ...
                        <div className="col-md-9" style={{ padding: "0px" }}>
                            {
                                ...
                                <VoterProvinceSummaryTable electId={this.state.electId} proId={this.state.proId} provinceCode={this.state.provinceCode} notify={this.notify} />
                            }

                            {
                                this.state.displayMunicipalityTable &&
                                <VoterMunicipalitySummaryTable electId={this.state.electId} proId={this.state.proId} provinceCode={this.state.provinceCode} municipalityNo={this.state.municipalityNo} notify={this.notify} />
                            }

                            {
                                this.state.displayBarangayTable &&
                                <VoterBarangaySummaryTable electId={this.state.electId} proId={this.state.proId} provinceCode={this.state.provinceCode} municipalityNo={this.state.municipalityNo} brgyNo={this.state.brgyNo} notify={this.notify} />
                            }
                            {
...
setTimeout(function () {
    ReactDOM.render(
        ...
        document.getElementById('voter-summary-container')
    );
}, 500);
