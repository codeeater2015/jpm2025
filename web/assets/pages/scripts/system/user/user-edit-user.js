var EditUser = function(){
    ...
    var clearForm = function(){
        ...
        form_edit_user.find("span.help-block").html("");
        form_edit_user.find('input:text:not([name="user_id"]), input:password, select, textarea').val('');
        form_edit_user.find('input:radio[value="Male"]').prop('checked',true);
        form_edit_user.find('input[name="status"]').bootstrapSwitch('state',true);
    };
