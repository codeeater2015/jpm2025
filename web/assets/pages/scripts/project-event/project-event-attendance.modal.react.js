                            ...
                            <div className="col-md-7" style={{ paddingLeft: "0px", marginBottom: "10px" }}>
                                ...
                                <div className="btn-group" style={{ marginLeft: "10px" }}>
                                    ...
                                    <ul className="dropdown-menu" role="menu">
                                        ...
                                        <li><a href="javascript:;" onClick={this.showAllAttendeesByPosition}>All Attendees By Position</a></li>
                                        <li><a href="javascript:;" onClick={this.showAllAttendeesByBarangay}>All Attendees By Barangay & Position</a></li>
