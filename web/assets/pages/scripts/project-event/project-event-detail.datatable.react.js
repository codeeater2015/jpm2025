            ...
            "dataTable": {
                ...
                "ajax": {
                    ...
                    "data": function (d) {
                        ...
                        d.croppedPhoto = $('#project_event_detail_datatable select[name="hasCroppedPhoto"]').val();
                    ...
                    <table id="project_event_detail_datatable" className="table table-striped table-bordered" width="100%">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="hasCroppedPhoto" onChange={this.handleFilterChange} className="input-sm" style={{ marginTop: "2px" }}>
                                        <option value=''>All</option>
                                        <option value='1'>Yes</option>
                                        <option value='0'>No</option>
                                    </select>
