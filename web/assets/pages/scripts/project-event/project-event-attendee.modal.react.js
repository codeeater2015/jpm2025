                    ...
                    <form id="voter-node-form" onSubmit={this.submit}>
                        <div className="row">
                            <div className="col-md-3">
                                <button style={{ marginBottom: "10px" }} onClick={this.openNewVoterCreateModal} className="btn btn-primary btn-sm" type="button"> Non-voter </button>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-md-12">
                                ...
                                <div className="col-md-6" style={{ paddingLeft: "0" }}>
                                    <FormGroup controlId="formPosition" validationState={this.getValidationState('position')}>
                                        ...
                                        <select id="position-select2" className="form-control input-sm">
                                            <option value=""> </option>
                                        </select>
