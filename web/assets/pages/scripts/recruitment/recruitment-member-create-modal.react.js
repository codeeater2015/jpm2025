...
var RecruitmentMemberCreateModal = React.createClass({
    ...
    loadVoter: function (proId, proVoterId) {
        ...
        self.requestVoter = $.ajax({
            ...
            var voterGroup = self.isEmpty(res.voterGroup) ? "KFC" : res.voterGroup;
    ...
    submit: function (e) {
        ...
        self.requestAddAttendee = $.ajax({
            url: Routing.generate("ajax_post_recruitment_detail"),
            type: "POST",
            data: data
        }).done(function (res) {
            self.reset();
...
window.RecruitmentMemberCreateModal = RecruitmentMemberCreateModal;