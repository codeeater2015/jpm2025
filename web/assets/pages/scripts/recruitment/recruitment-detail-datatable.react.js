...
var RecruitmentDetailDatatable = React.createClass({
    ...
    initDatatable: function (recId) {
        ...
        var url = Routing.generate("ajax_get_datatable_recruitment_detail", { recId: recId }, true);
    ...
    delete: function (id) {
        ...
        if (confirm("Are you sure you want to remove recruit?")) {
            self.requestDelete = $.ajax({
                url: Routing.generate("ajax_delete_recruitment_detail", { id: id }),
                type: "DELETE"
            }).done(function (res) {
                self.reload();
            });
...
window.RecruitmentDetailDatatable = RecruitmentDetailDatatable;