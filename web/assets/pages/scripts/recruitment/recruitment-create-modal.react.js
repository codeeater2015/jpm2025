...
var RecruitmentCreateModal = React.createClass({
        ...
        return (
            <Modal style={{ marginTop: "10px" }} keyboard={false} bsSize="lg" enforceFocus={false} backdrop="static" show={this.props.show} onHide={this.props.onHide}>
                <Modal.Header className="modal-header bg-blue-dark font-white" closeButton>
                    <Modal.Title>Recruitment Form</Modal.Title>
                </Modal.Header>
    ...
    initSelect2: function () {
        ...
        $("#household-create-form #voter_group_select2").select2({
            ...
            ajax: {
                url: Routing.generate('ajax_select2_voter_group_kfc'),
                data: function (params) {
                    return {
                        searchText: params.term
                    };
    ...
    submit: function (e) {
        ...
        self.requestPost = $.ajax({
            url: Routing.generate("ajax_post_recruitment_header"),
            data: data,
            type: 'POST'
        }).done(function (res) {
            self.reset();
...
window.RecruitmentCreateModal = RecruitmentCreateModal;