var Recruitment2NotSubmittedDatatable = React.createClass({
    ...
    initDatatable: function () {
        ...
        var url = Routing.generate("ajax_get_datatable_recruitment_not_submitted", {}, true);
        ...
        recruitment_table.on('click', '.hover-button', function () {
            ...
            self.displayPreview(data.pro_voter_id);
        });
    ...
    loadHeader: function (id) {
        ...
        self.requestRecruiter = $.ajax({
            url: Routing.generate("ajax_get_project_voter", { proId : this.props.proId, proVoterId : id }),
            type: "GET"
        }).done(function (res) {
...
window.Recruitment2NotSubmittedDatatable = Recruitment2NotSubmittedDatatable;