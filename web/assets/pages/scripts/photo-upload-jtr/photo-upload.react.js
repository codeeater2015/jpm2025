...
var PhotoUpload = React.createClass({
    ...
    componentDidMount: function () {
        var myDropzone = new Dropzone("#photo-uploader", { url: Routing.generate("ajax_field_photo_upload_jtr", {}) });
    ...
    initSelect2: function () {
        ...
        $("#form-barangay-select2").on("change", function () {
            ...
            var myDropzone = new Dropzone("#photo-uploader", {
                url: Routing.generate("ajax_field_photo_upload_jtr", {
                    brgyNo: $(this).val(),
                    municipalityName : $("#form-municipality-select2").val()
                })
            });
            ...
            <div>
                <div className="row">
                    <div className="col-md-8">
                        <div className="portlet light portlet-fit bordered">
                            <div className="portlet-body">
                                <div className="row">
                                    <div className="col-md-8">
                                        <h4><strong>JPM-JTR Photo Uploads</strong></h4>
                                    </div>
                                </div>
                    ...
                    <div className="col-md-4">
                        <div className="portlet light portlet-fit bordered">
                            <div className="portlet-body">
                                <h4><strong>Upload JTR Images Here</strong></h4>
