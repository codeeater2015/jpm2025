...
var PhotoUploadItemsModal = React.createClass({
    ...
    initDatatable: function () {
        ...
        var url = Routing.generate("ajax_datatable_field_upload_items_jtr", { id: this.props.id }, true);
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row) {
                            let imgUrl = Routing.generate("ajax_get_field_upload_photo_jtr", { id: data });
    ...
    delete: function (id) {
        ...
        if (confirm("continue delete?")) {
            self.requestDelete = $.ajax({
                url: Routing.generate("ajax_delete_field_upload_item_jtr", { id: id }),
                type: "DELETE"
            }).done(function (res) {
...
window.PhotoUploadItemsModal = PhotoUploadItemsModal;