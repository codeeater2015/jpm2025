...
var VoterNetworkComponent = React.createClass({
                        ...
                        <div className="col-md-5">
                            ...
                            <form>
                                ...
                                <FormGroup controlId="formBarangayNo">
                                    ...
                                    <select id="form-precinct-select2" className="form-control input-sm">
                                    </select>
                                </FormGroup>
                            </form>
                                ...
                                <div className="row" style={{ marginBottom : "10px" }}>
                                    <div className="col-md-6">
                                        <select name="nodeLevel" className="form-control input-sm" value={this.state.nodeLevel} onChange={this.setNodeLevel} >
                                            ...
                                            <option value="2">KCL</option>
                                            <option value="3">KCL 0</option>
                                            <option value="4">KCL 1</option>
                                            <option value="5">KCL 2</option>
                                            <option value="6">KCL 3</option>
                                        </select>
                                    </div>
                                    <div className="col-md-6">
    ...
    initSelect2: function () {
        ...
        $("#form-precinct-select2").select2({
            ...
            containerCssClass: ':all:',
            ajax: {
                url: Routing.generate('ajax_select2_precinct_no_strict'),
                data: function (params) {
                    return {
                        searchText : params.term,
                        provinceCode : $("#form-province-select2").val(),
                        ...
                        electId :  $("#form-election-select2").val()
                    };
                },
                processResults: function (data, params) {
                    return {
