var VoterMunicipalityAssistanceSummaryTable = React.createClass({
    ...
    loadData : function(){
        this.loadMunicipalityData(this.props.provinceCode, this.props.municipalityNo);
    ...
    loadMunicipalityData : function(provinceCode,municipalityNo){
        var self = this;

        self.requestProvinceData = $.ajax({
            url : Routing.generate("ajax_get_municipality_data_assistance_summary",{provinceCode : provinceCode, municipalityNo : municipalityNo}),
            type : "GET"
        }).done(function(res){
                    ...
                    <table id="voter_summary_table" className="table table-striped table-bordered" width="100%">
                        <thead className="bg-blue-dark font-white">
                            <tr>
                                ...
                                <th className="text-center" rowSpan="2">Barangay</th>
                                <th className="text-center" rowSpan="2">TotalAmount</th>
                                <th className="text-center" rowSpan="2"></th>
                            </tr>
                        </thead>
                        <tbody>
...
window.VoterMunicipalityAssistanceSummaryTable = VoterMunicipalityAssistanceSummaryTable;