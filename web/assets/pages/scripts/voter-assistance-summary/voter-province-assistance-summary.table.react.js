var VoterProvinceAssistanceSummaryTable = React.createClass({
    ...
    loadData : function(){
        ...
        this.loadProvinceData(this.props.provinceCode);
        this.initCounter();
    },
    ...
    loadProvinceData : function(provinceCode){
        var self = this;
        
        self.requestProvinceData = $.ajax({
            url : Routing.generate("ajax_get_province_data_summary",{provinceCode : provinceCode}),
            type : "GET"
        }).done(function(res){
...
window.VoterProvinceAssistanceSummaryTable = VoterProvinceAssistanceSummaryTable;