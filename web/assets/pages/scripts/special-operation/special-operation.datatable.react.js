var SpecialOperationDatatable = React.createClass({
        ...
        return (
            <div>
...

                {
                    ...
                    <SpecialOperationUploadPhotoModal
                        id={this.state.target}
                    ...
                    <table id="recruitment_table" className="table table-striped table-bordered" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th className="text-center">Total Photos</th>
