var ProjectRecruitmentSummary = React.createClass({
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-9" style={{ padding: "0px" }}>

                            {
                                ...
                                <ProjectRecruitmentProvinceSummaryTable electId={this.state.electId} proId={this.state.proId} provinceCode={this.state.provinceCode} notify={this.notify} />
                            }

                            {
                                this.state.displayMunicipalityTable &&
                                <ProjectRecruitmentMunicipalitySummaryTable electId={this.state.electId} proId={this.state.proId} provinceCode={this.state.provinceCode} municipalityNo={this.state.municipalityNo} notify={this.notify} />
                            }

                            {
                                this.state.displayBarangayTable &&
                                <ProjectRecruitmentBarangaySummaryTable electId={this.state.electId} proId={this.state.proId} provinceCode={this.state.provinceCode} municipalityNo={this.state.municipalityNo} brgyNo={this.state.brgyNo} notify={this.notify} />
                            } 
