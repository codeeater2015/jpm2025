var ProjectClaimStubSection = React.createClass({
      ...
      <div className="portlet light bordered overflow-auto">
        <div className="portlet-body">
          <div className="col-md-6">
            <h3 className="h3 m-b-md">Claim Stub Manager</h3>
          ...
          {this.state.showCreateModal && <ProjectClaimStubCreateModal 
...
window.ProjectClaimStubSection = ProjectClaimStubSection;

setTimeout(function () {
  ReactDOM.render(
    <ProjectClaimStubSection />,
