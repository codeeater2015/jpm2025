var JpmAssistanceDatatable = React.createClass({
        ...
        grid_project_event.init({
            ...
            "dataTable": {
                ...
                "ajax": {
                    ...
                    "type": 'GET',
                    "data": function (d) {
                        d.assistDesc = $('#jpm_assistance_datatable input[name="assistDesc"]').val();
                        ...
                        d.releaseDate = $('#jpm_assistance_datatable input[name="releaseDate"]').val();
                        d.assistType = $('#jpm_assistance_datatable input[name="assistType"]').val();
                    }
                },
                "columnDefs": [{
                    'orderable': false,
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <td style={{ padding: "10px 5px" }}>
                                    <input type="text" className="form-control form-filter input-sm" name="assistDesc" onChange={this.handleFilterChange} />
                                </td>
                                <td style={{ padding: "10px 5px" }}>
                                ...
                                <td>
                                     <input type="text" className="form-control form-filter input-sm" name="releaseDate" onChange={this.handleFilterChange} />
                                </td>
                                <td>
                                    <input type="text" className="form-control form-filter input-sm" name="assistType" onChange={this.handleFilterChange} />
                                </td>
                                <td style={{ padding: "10px 5px" }}>
                                </td>
                            </tr>
...
window.JpmAssistanceDatatable = JpmAssistanceDatatable;