var ProjectRecruitmentDatatable = React.createClass({
    ...
    initDatatable: function () {
        ...
        var url = Routing.generate("ajax_get_datatable_project_recruitment_header", {}, true);
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "render" : function(data,type,row){
                            return ((row.total_with_cellphone / row.total_members) * 100).toFixed(2);
                        }
                    },
                    {
                        "data": "total_members",
    ...
    render: function () {
        return (
            <div>
                ...
                {
                    this.state.showCreateKCL1Modal &&
                    <ProjectRecruitmentCreateKCL1Modal
                        proId={this.state.filters.proId}
                        electId={this.state.filters.electId}
                        provinceCode={this.state.filters.provinceCode}
                        show={this.state.showCreateKCL1Modal}
                        notify={this.props.notify}
                        reload={this.reload}
                        onHide={this.closeCreateKCL1Modal}
                    />
                }

                {
                    this.state.showRecruitsModal &&
                    <ProjectRecruitsModal
                        proId={this.state.filters.proId}
                        electId={this.state.filters.electId}
                        provinceCode={this.state.filters.provinceCode}
                ...
                <div className="row" id="handler_component">
                    <div className="col-md-5">
                        ...
                        <button type="button" style={{ marginLeft : "10px" }} className="btn btn-primary" onClick={this.openCreateKCL1Modal}>New KCL1</button>
                    </div>
...
window.ProjectRecruitmentDatatable = ProjectRecruitmentDatatable;