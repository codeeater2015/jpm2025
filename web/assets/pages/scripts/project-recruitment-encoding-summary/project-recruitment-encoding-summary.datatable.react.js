var ProjectRecruitmentEncodingSummaryDatatable = React.createClass({
    ...
    initDatatable: function () {
        ...
        var url = Routing.generate("ajax_get_datatable_project_recruitment_encoding_summary", {}, true);
                ...
                "columns": [
                    ...
                    { 
                        ...
                        "render" : function(data){
                            return moment(new Date(data)).format('MMMM DD, YYYY');
                        }
                    },
                    { 
                        "data": "total_recruiter" , 
                        "className": "text-center", 
                        width : 150
                    },
                    { 
                    ...
                    <table id="project_recruitment_summary_table" className="table table-striped table-bordered" width="100%">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Entry Date</th>
                                <th className="text-center">Total Encoded Forms</th>
                                <th className="text-center">Total Encoded Recruits</th>
                                <th className="text-center">With Cellphone No</th>
...
window.ProjectRecruitmentEncodingSummaryDatatable = ProjectRecruitmentEncodingSummaryDatatable;