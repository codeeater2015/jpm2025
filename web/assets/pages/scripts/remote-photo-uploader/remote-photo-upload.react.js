...
var RemotePhotoUpload = React.createClass({
                    ...
                    <div className="col-md-8">
                        <div className="portlet light portlet-fit bordered">
                            <div className="portlet-body">
                                <div className="row">
                                    <div className="col-md-8">
                                        <h4><strong>Remote Photo Uploads</strong></h4>
                                    </div>
                                ...
                                {this.state.showDatatable &&
                                    <RemotePhotoUploadDatatable ref="fieldDatatable" voterGroup={this.state.voterGroup} municipalityName={this.state.municipalityName} />
                                }
                            </div>
                        </div>
                    </div>
