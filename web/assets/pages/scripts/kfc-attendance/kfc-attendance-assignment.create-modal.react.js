...
var KfcAttendanceAssignmentCreateModal = React.createClass({
        ...
        return (
            <Modal style={{ marginTop: "30px" }} keyboard={false} enforceFocus={false} backdrop="static" show={this.props.show} onHide={this.props.onHide}>
                <Modal.Header className="modal-header bg-blue-dark font-white" closeButton>
                    <Modal.Title>New Assignment Profile</Modal.Title>
                </Modal.Header>
                        ...
                        <div className="row">
                            <div className="col-md-4" >
                                <FormGroup controlId="formBirthdate" validationState={this.getValidationState('birthdate')}>
                                    ...
                                    <input type="date" value={this.state.form.data.birthdate} name="birthdate" className="input-md form-control" onChange={this.setFormProp} />
